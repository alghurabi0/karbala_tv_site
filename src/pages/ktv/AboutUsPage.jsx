        ...
        <div className="about-us-content">
          ...
          <div className="about-us-up">
            ...
            <section className="about-us-paragraph">
              ...
              جمهورية العراق يد بيضاء في دعم هذه القناة التي أخذت على عاتقها أن
              تكون بمستوى أهمية الدور، وعظم المسؤولية، وضخامة الأمانة التي
              يحتـّـمها الواجب الديني العقيدي.. معتمدة الخطاب الفكري الثقافي
              المعاصر الذي يأخذ أصالته من القرآن الكريم والسنة المعصومة الصحيحة
              المطهرة لنبي الإسلام وأهل بيته الكرام (عليه وعليهم أفضل الصلاة
              والسلام)، مع ما يتصل بها من استمرارية مباركة تمثلت بالمرجعية
              الدينية وعلى رأسها سماحة المرجع الديني الأعلى آية الله العظمى
          ...
          <div className="about-us-middle">
            ...
            <section className="about-us-paragraph">
              (2) السعي لتوحيد كلمة المسلمين، بما لا يضر بالثوابت المشار إليها،
              والعمل على إيجاد مناخات سليمة للتآلف والتعاون والتفاهم والتعارف
              بين المسلمين. ومدّ الجسور المبدئية مع باقي الأديان، ومع المنجز
              الحضاري العالمي فيما يتصل بالفكر والثقافة والخطاب الإنساني الشامل،
              الذي يأخذ على عاتقه مسؤولية خدمة الإنسان، أياً كان، وفي أي مكان
              وزمان، وهذا ما ورثناه من مدرسة أهل بيت المصطفى (عليه وعليهم التحية
              والسلام).
            </section>
            <section className="about-us-paragraph">
              (3) ردّ الشبهات بالدليل والبرهان، لكن لا بشكل استفزازي، ولا بهيئة
              ردود الأفعال، بل باستعراض ما في مدرسة أهل البيت (عليهم السلام)،
              وهذا بدوره يأخذ مداه في التعريف بها، وردّ الشبهات المثارة ضدها.
            </section>
            <section className="about-us-paragraph">
            ...
            <section className="about-us-paragraph">
              (5) التعريف بالتراث العلمي المغمور أو المهمش الذي يتصل بعطاء النبي
              الأكرم ومدرسة أهل بيته الكرام (عليهم السلام)، وإبراز الجهد المكنون
              للعلماء والأدباء والفلاسفة والمبدعين من هذه المدرسة العملاقة، مع
              التنويه بدورهم في بناء المجتمعات الإنسانية.
            </section>
            <section className="about-us-paragraph">
              (6) التعريف بالمشاهد المشرفة لأهل البيت (عليهم السلام)، والعمل على
              نشر الزيارة كثقافة نستلهم منها دروس الكرامة والإيمان التي استُشهد
              من أجلها الأئمة الشهداء وأصحابهم الكرام (عليهم السلام والرضوان)،
              مع تبيان أهداف الزيارة ومعانيها وآدابها.
            </section>
            <section className="about-us-paragraph">
            ...
            <section className="about-us-paragraph">
              ...
              خلال بث برامج دينية، وتربوية، وثقافية، بالإضافة إلى برامج ترفيهية،
              وبرامج أطفال وشباب وأُسرة، برؤية إسلامية.
            </section>
          </div>
